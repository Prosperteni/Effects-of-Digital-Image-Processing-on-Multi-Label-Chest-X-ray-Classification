...
if __name__ == '__main__':
    print("="*60)
    print("DENSENET-121 TRAINING (OPTIMIZED - BATCH SIZE 256)")
    print("="*60)
    ...
    # OPTIMIZED DATALOADERS for batch size 256
    ...
    print(f"Model saved to: best_densenet_nih.pth")
    print("="*60)