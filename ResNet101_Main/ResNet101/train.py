...
BATCH_SIZE = 128                     # ResNet-101 is larger, use smaller batch
EPOCHS = 100
LEARNING_RATE = 4e-4                 # Scaled for batch size 128 (1e-4 * 4)
IMG_SIZE = 224
NUM_CLASSES = 14
...
if __name__ == '__main__':
    print("="*60)
    print("RESNET-101 TRAINING (BATCH SIZE 128)")
    print("="*60)
    ...
    # Model - RESNET-101 (CHANGED THIS LINE)
    print("\nBuilding ResNet-101 model...")
    model = models.resnet101(pretrained=True)  # ← CHANGED: resnet50 → resnet101
    ...
    for epoch in range(EPOCHS):
        ...
        if val_auc > best_val_auc:
            ...
            }, 'best_resnet101_nih.pth')  # ← CHANGED: filename
    ...
    print(f"Model saved to: best_resnet101_nih.pth")
    print("="*60)