"""
Vision Transformer (ViT-Base-16) Training for NIH Chest X-ray
ViT-B/16 architecture with 16x16 patches, pretrained on ImageNet-21k
"""
...
BATCH_SIZE = 64                     # ViT is larger, use moderate batch size
EPOCHS = 100
LEARNING_RATE = 1e-4
IMG_SIZE = 224
NUM_CLASSES = 14
...
def create_vit_model(model_name, num_classes=14):
    """Create ViT-Base-16 model using timm"""
...
if __name__ == '__main__':
    print("="*60)
    print("VIT-BASE-16 TRAINING ON NIH CHEST X-RAY")
    print("="*60)
    ...
    print(f"Model saved to: best_vit_nih.pth")
    print("="*60)