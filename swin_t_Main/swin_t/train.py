...
BATCH_SIZE = 128                     # Swin is efficient but larger than ViT
EPOCHS = 100
...
# Swin Transformer variants (increasing size/accuracy):
# - microsoft/swin-tiny-patch4-window7-224 (28M params) - Fastest
# - microsoft/swin-small-patch4-window7-224 (50M params)
# - microsoft/swin-base-patch4-window7-224 (88M params) - Best accuracy

MODEL_NAME = "swin_tiny_patch4_window7_224"  # FIXED: underscores instead of hyphens
PATHOLOGIES = [
...
def create_swin_model(model_name, num_classes=14):
    """Create Swin Transformer model for multi-label classification"""
...
if __name__ == '__main__':
    print("="*60)
    print("SWIN TRANSFORMER TRAINING ON NIH CHEST X-RAY")
    print("="*60)
    ...
    print(f"\nBuilding Swin Transformer model: {MODEL_NAME}")
    ...
    best_val_auc = 0.0
    early_stopping = EarlyStopping(patience=12, metric="loss", mode="min")
    ...
    print(f"Model saved to: best_swin_nih.pth")
    print("="*60)